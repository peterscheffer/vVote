...
/**
 * Servlet implementation class DiscardSlip
 */
@WebServlet(description = "Discards slip for specific serial number", urlPatterns = { "/discardSlip" })
public class DiscardSlip extends HttpServlet {
