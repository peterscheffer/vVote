...
/**
 * Servlet implementation class AuditSlip
 */
@WebServlet(description = "Audits slip for specific serial number", urlPatterns = { "/auditSlip" })
public class AuditSlip extends HttpServlet {
