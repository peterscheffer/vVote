...
/**
 * Servlet implementation class ExpireSlip
 */
@WebServlet(description = "Expires slip for specific serial number", urlPatterns = { "/expireSlip" })
public class ExpireSlip extends HttpServlet {
