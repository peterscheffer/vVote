...
function Hammer(element, options, undefined)
{
    ...
    var defaults = {
        ...
        swipe              : true,
        swipe_time         : 100,   // ms
        swipe_min_distance : 250, // pixels

        drag               : true,
        drag_vertical      : true,
        drag_horizontal    : true,
        // minimum distance before the drag event starts
        drag_min_distance  : 30, // pixels
    ...
    if(_has_touch) {
        addEvent(element, "touchstart touchmove touchend touchcancel", this.handleEvents);
    }
    // for non-touch
    else {
        addEvent(element, "mouseup mousedown mousemove", this.handleEvents);
