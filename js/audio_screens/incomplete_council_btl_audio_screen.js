 ...
 *
 *
 * IncompleteCouncilBtlAudioScreen - The audio screen class for the incomplete council BTL warning for the blind interface.
 * 
 * @author Peter Scheffer
 */

var IncompleteCouncilBtlAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    var callback1 = function () {
      ...
      var instructions = new AudioInstructions(['informal_council_btl_warning'], true, true, callback2);     
      var container = getContainer();
      var audioController = container.Resolve("audioController");
    ...
    var clips = new Array();
    clips = clips.concat(['informal_council_btl_warning']);
