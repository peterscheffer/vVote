 ...
 *
 *
 * TvsSwitchToAtlAudioScreen - The audio screen class for the switch from BTL to ATL warning for the TVS blind interface.
 * 
 * @author Peter Scheffer
 */

var TvsSwitchToAtlAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    // If the user didn't vote BTL, then we can skip this Switch to ATL warning.
    ...
    if (selectionCount == 0) {    
      ...
      audioScreenManager.execute({ 
        request: 'enterScreen', 
        data: 'tvs_legislative_council_group_vote_screen', 
    ...
    var callback1 = function () {
      ...
      var clips = [ ['switch_to_atl_warning_screen'], ['one_back_two_continue'] ];
