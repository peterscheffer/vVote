 ...
 *
 *
 * PrintReceiptAudioScreen - The audio screen class for printing the receipt screen for the blind interface.
 * 
 * @author Peter Scheffer
 */

var PrintReceiptAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    // At end of playing the complete intro sequence, play the instructions again.
    var callback1 = function () {
      ...
      var clips = [ ['print_receipt_intro'], ['print_again_swipe_right'] ];
    ...
    clips = clips.concat([ ['print_receipt_intro'], ['print_again_swipe_right'] ]);
  ...
  playShuffleOrder: function () {
    ...
    if (districtIsUncontested) {
      ...
      clips = clips.concat(['print_shuffle_explanation_a']);
    ...
    if (userVotedAboveOrBelow == "above") {
      clips = clips.concat(['print_shuffle_explanation_b_atl']);
      var atl = container.Resolve("atl");
      ...
      clips = clips.concat(['print_shuffle_explanation_b_btl']);
      var btl = container.Resolve("btl");
    ...
    clips = clips.concat(['print_shuffle_explanation_c']);
