 ...
 *
 *
 * TvsQuitSystemAudioScreen - The audio screen class for confirming to quit the system for the TVS blind interface.
 * 
 * @author Peter Scheffer
 */

var TvsQuitSystemAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    var callback1 = function () {
      ...
      var instructions = new AudioInstructions(['tvs_confirm_end_voting'], true, true, callback2);     
      var container = getContainer();
      var audioController = container.Resolve("audioController");
    ...
    var container = getContainer();
    var audioController = container.Resolve("audioController");
    var instructions = new AudioInstructions(['tvs_confirm_end_voting'], true, true, callback1);
    audioController.playAudioInstructions(instructions);
  }
});