 ...
 *
 *
 * SwitchToAtlAudioScreen - The audio screen class for the switch from BTL to ATL warning for the blind interface.
 * 
 * @author Peter Scheffer
 */

var SwitchToAtlAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    if (selectionCount == 0) {    
      ...
      audioScreenManager.execute({ 
        request: 'enterScreen', 
        data: 'legislative_council_group_vote_screen', 
    ...
    var callback1 = function () {
      ...
      var clips = [ ['switch_to_atl_warning_screen'], ['left_back_right_continue'] ];
