 ...
 *
 *
 * TvsUncontestedLegislativeAssemblyAudioScreen - The audio screen class for an uncontested assembly ballot for the blind interface.
 * 
 * @author Peter Scheffer
 */
 
var TvsUncontestedLegislativeAssemblyAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
