 ...
 *
 *
 * ClearBallotAudioScreen - The audio screen class for confirming to clear a ballot of selections for the blind interface.
 * 
 * @author Peter Scheffer
 */

var ClearBallotAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    var callback1 = function () {
      ...
      var instructions = new AudioInstructions(['confirm_clear_ballot'], true, true, callback2);     
      var container = getContainer();
      var audioController = container.Resolve("audioController");
    ...
    var container = getContainer();
    var audioController = container.Resolve("audioController");
    var instructions = new AudioInstructions(['confirm_clear_ballot'], true, true, callback1);
    audioController.playAudioInstructions(instructions);
  }
});