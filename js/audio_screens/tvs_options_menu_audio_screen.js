 ...
 *
 *
 * TvsOptionsMenuAudioScreen - The audio screen class for the options menu screen for the TVS blind interface.
 * 
 * @author Peter Scheffer
 */

var TvsOptionsMenuAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    var callback1 = function () {
      ...
      var instructions = new AudioInstructions(['options_menu'], true, true, callback2);     
      var container = getContainer();
      var audioController = container.Resolve("audioController");
    ...
    var container = getContainer();
    var audioController = container.Resolve("audioController");
    var instructions = new AudioInstructions(['options_menu'], true, true, callback1);
    audioController.playAudioInstructions(instructions);
  }
