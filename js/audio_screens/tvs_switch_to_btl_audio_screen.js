 ...
 *
 *
 * TvsSwitchToBtlAudioScreen - The audio screen class for the switch from ATL to BTL warning for the TVS blind interface.
 * 
 * @author Peter Scheffer
 */

var TvsSwitchToBtlAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    if (selectionCount == 0) {    
      ...
      audioScreenManager.execute({ 
        request: 'enterScreen', 
        data: 'tvs_legislative_council_candidate_vote_screen', 
    ...
    var callback1 = function () {
      ...
      var clips = [ ['switch_to_btl_warning_screen'], ['one_back_two_continue'] ];
