 ...
 *
 *
 * IncompleteAssemblyAudioScreen - The audio screen class for the incomplete assembly warning for the blind interface.
 * 
 * @author Peter Scheffer
 */

var IncompleteAssemblyAudioScreen = AudioScreen.extend({  
  init: function () {
    this._super();
  },
  ...
  initialEntry: function () {
    ...
    var callback1 = function () {
      ...
      var instructions = new AudioInstructions(['legislative_assembly_informal_warning'], true, true, callback2);     
      var container = getContainer();
      var audioController = container.Resolve("audioController");
    ...
    var clips = new Array();
    clips = clips.concat(['legislative_assembly_informal_warning']);
