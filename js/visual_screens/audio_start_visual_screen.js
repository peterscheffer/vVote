 ...
 *
 *
 * AudioStartVisualScreen - The visual screen class for the initial audio start screen for the visual interface.
 * 
 * @author Peter Scheffer
 */
 
var AudioStartVisualScreen = Screen.extend({  
  init: function () {
    ...
    this._super(visualScreenManager, 'audio_start_screen', 
  ...
  switchToAudioInterface: function () {
    ...
    audioController.enterScreen(null, null, 'audio_start_screen');
  },
