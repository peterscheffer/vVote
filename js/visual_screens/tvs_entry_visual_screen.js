 ...
 *
 *
 * TvsEntryVisualScreen - The visual screen class for the initial TVS entry screen for the visual interface.
 * 
 * @author Peter Scheffer
 */
 
var TvsEntryVisualScreen = Screen.extend({  
  init: function () {
    ...
    this._super(visualScreenManager, 'tvs_entry_screen', 
  ...
  switchToAudioInterface: function () {
    ...
    audioController.enterScreen(null, null, 'tvs_entry_screen');
  },
