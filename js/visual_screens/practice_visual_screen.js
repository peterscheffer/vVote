 ...
 *
 *
 * PracticeVisualScreen - The visual screen class for the initial audio practice screen for the visual interface.
 * 
 * @author Peter Scheffer
 */
 
var PracticeVisualScreen = Screen.extend({  
  init: function () {
    ...
    this._super(visualScreenManager, 'practice_screen', 
  ...
  switchToAudioInterface: function () {
    ...
    audioController.enterScreen(null, null, 'practice_screen');
  },
