 ...
 *
 *
 * LegislativeAssemblySummaryVisualScreen - The visual screen class for the 
 * legislative assembly summary screen for switching to the visual interface.
 * 
 * @author Peter Scheffer
 */

var LegislativeAssemblySummaryVisualScreen = Screen.extend({
  init: function () {
    ...
    audioScreenManager.setMajorBlindInterfaceScreen('confirm_assembly_votes_screen');
    this._super(visualScreenManager, 'confirm_assembly_votes_screen',   
